/*:
 ...
 Modern methods of data collection is important to understand geographic events. Using code we can access live data from the United Stated Geogrphical Services databases.
